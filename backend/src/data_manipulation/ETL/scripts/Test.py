...
Usage:
    ...
    Examples:
        python -m src.data_manipulation.ETL.scripts.Test -csv -6e
        python -m src.data_manipulation.ETL.scripts.Test -csv -xbeams -upload
        python -m src.data_manipulation.ETL.scripts.Test -csv (tests all beams defined in paths)
Command:
    python -m src.data_manipulation.ETL.scripts.Test
Options:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        usage="python -m src.data_manipulation.ETL.scripts.Test [options]"
    )
